...
Config.ESX = false -- Set to true if you are using ESX framework
...
Config.EnableLogs = {
    ...
    PlayerLeave = true,
    Kill = true,
    NewPlayer = false, -- ESX only at the moment
    txAdminActions = true,
}
...
Config.WebhookURL = {
    ...
    AdminActions = 'YOUR_WEBHOOK_URL_HERE',
}
